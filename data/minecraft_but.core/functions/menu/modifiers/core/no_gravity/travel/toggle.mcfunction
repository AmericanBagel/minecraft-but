#> minecraft_but.coreraft_but.core:menu/modifiers/core/no_gravity/travel/toggle
# Toggle no_gravity config score travel between 0 and 1
# Generated with the script at '../src/index.js'
#
# @within minecraft_but.coreraft_but.core:menu/modifiers/core/no_gravity/**
# @context player
...
# Update menu
function minecraft_but.coreraft_but.core:menu/modifiers/core/no_gravity/config