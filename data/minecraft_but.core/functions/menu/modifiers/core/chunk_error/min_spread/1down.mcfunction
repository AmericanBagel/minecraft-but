#> minecraft_but.core:menu/modifiers/core/chunk_error/min_spread/1down
# Increase chunk_error config score min_spread by 1
...
#> Remove 1 from score
scoreboard players remove chunk_error.min_spread minecraft_but.config 1
