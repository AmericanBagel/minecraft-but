#> minecraft_but.core:menu/modifiers/core/chunk_error/max_spread/5down
# Increase chunk_error config score max_spread by 5
...
#> Remove 5 from score
scoreboard players remove chunk_error.max_spread minecraft_but.config 5
