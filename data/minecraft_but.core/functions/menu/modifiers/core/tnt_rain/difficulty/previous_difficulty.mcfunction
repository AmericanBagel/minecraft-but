#> minecraft_but.coreraft_but.core:menu/tnt_rain/difficulty/previous_difficulty
...
execute unless score difficulty.tnt_rain minecraft_but.config matches 0..3 run scoreboard players operation difficulty.tnt_rain minecraft_but.config = difficulty.global minecraft_but.config

#> Set difficulty to temp score
scoreboard players operation #temp minecraft_but.config = difficulty.tnt_rain minecraft_but.config
...
scoreboard players operation difficulty.tnt_rain minecraft_but.config = #temp minecraft_but.config
