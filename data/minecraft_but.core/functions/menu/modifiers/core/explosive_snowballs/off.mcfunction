#> minecraft_but.coreraft_but.core:menu/modifiers/core/explosive_snowballs/off
...
# Run unload function
function minecraft_but.coreraft_but.core:modifiers/explosive_snowballs/unload
