#> minecraft_but.core:menu/modifiers/core/explosive_eggs/radius/reset
# Reset explosive_eggs config score radius to default
# Generated with the script at '../src/index.js'
#
# @within minecraft_but.core:menu/modifiers/core/explosive_eggs/**
# @context player
...
#> Update menu
function minecraft_but.core:menu/modifiers/core/explosive_eggs/config