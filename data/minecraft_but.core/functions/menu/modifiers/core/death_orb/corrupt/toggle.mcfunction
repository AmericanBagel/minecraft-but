#> minecraft_but.core:menu/modifiers/core/death_orb/corrupt/toggle
# Toggle death_orb config score corrupt between 0 and 1
# Generated with the script at '../src/index.js'
#
# @within minecraft_but.core:menu/modifiers/core/death_orb/**
# @context player
...
# Update menu
function minecraft_but.core:menu/modifiers/core/death_orb/config