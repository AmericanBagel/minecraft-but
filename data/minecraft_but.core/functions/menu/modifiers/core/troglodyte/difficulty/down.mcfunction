#> minecraft_but.coreraft_but.core:menu/modifiers/core/troglodyte/difficulty/down
...
function minecraft_but.coreraft_but.core:menu/modifiers/core/troglodyte/difficulty/update_string
