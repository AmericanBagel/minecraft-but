#> minecraft_but.coreraft_but.core:menu/modifiers/core/creeper_reinforcements/off
...
# Run unload function
function minecraft_but.coreraft_but.core:modifiers/creeper_reinforcements/unload
