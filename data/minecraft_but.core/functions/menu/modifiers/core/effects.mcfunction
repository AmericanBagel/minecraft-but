...
execute unless score damage_nausea minecraft_but.toggle matches 1 run tellraw @s [{"text":" [✖] ","bold":false,"color":"#FF0000","clickEvent":{"action":"run_command","value":"/function minecraft_but.core:menu/modifiers/core/damage_nausea/on"}},{"text":"     ","hoverEvent": {"action":"show_text","contents":[{"text":"Nausea, the most annoying effect. Imagine getting it every time you get hit! It might make you actually nauseous in real life!","color":"#ECEFF5"}]}},{"text":"Taking damage nauseates you","bold":false,"color":"#54b9cc","hoverEvent": {"action":"show_text","contents":[{"text":"Nausea, the most annoying effect. Imagine getting it every time you get hit! It might make you actually nauseous in real life!","color":"#ECEFF5"}]}}]


execute if score damage_nausea minecraft_but.toggle matches 1 run tellraw @s [{"text":" [✔] ","bold":false,"color":"#3ED011","clickEvent":{"action":"run_command","value":"/function minecraft_but.core:menu/modifiers/core/damage_nausea/off"}},{"text":"     ","hoverEvent": {"action":"show_text","contents":[{"text":"Nausea, the most annoying effect. Imagine getting it every time you get hit! It might make you actually nauseous in real life!","color":"#ECEFF5"}]}},{"text":"Taking damage nauseates you","bold":false,"color":"#54b9cc","hoverEvent": {"action":"show_text","contents":[{"text":"Nausea, the most annoying effect. Imagine getting it every time you get hit! It might make you actually nauseous in real life!","color":"#ECEFF5"}]}}]

## Glowing (glowing)
execute unless score glowing minecraft_but.toggle matches 1 run tellraw @s [{"text":" [✖] ","bold":false,"color":"#FF0000","clickEvent":{"action":"run_command","value":"/function minecraft_but.core:menu/modifiers/core/glowing/on"}},{"text":"[","color":"#CACACA","clickEvent":{"action":"run_command","value":"/function minecraft_but.core:menu/modifiers/core/glowing/config"}},{"text":"⚙","bold":true,"color":"#CACACA","clickEvent":{"action":"run_command","value":"/function minecraft_but.core:menu/modifiers/core/glowing/config"}},{"text":"] ","color":"#CACACA","bold":false,"clickEvent":{"action":"run_command","value":"/function minecraft_but.core:menu/modifiers/core/glowing/config"}},{"text":"Glowing","bold":false,"color":"#46cb99","hoverEvent": {"action":"show_text","contents":[{"text":"Players or mobs glow, depending on your configuration. They can glow permanently or at an interval such as every minute.","color":"#ECEFF5"}]}}]



execute if score glowing minecraft_but.toggle matches 1 run tellraw @s [{"text":" [✔] ","bold":false,"color":"#3ED011","clickEvent":{"action":"run_command","value":"/function minecraft_but.core:menu/modifiers/core/glowing/off"}},{"text":"[","color":"#CACACA","clickEvent":{"action":"run_command","value":"/function minecraft_but.core:menu/modifiers/core/glowing/config"}},{"text":"⚙","bold":true,"color":"#CACACA","clickEvent":{"action":"run_command","value":"/function minecraft_but.core:menu/modifiers/core/glowing/config"}},{"text":"] ","color":"#CACACA","bold":false,"clickEvent":{"action":"run_command","value":"/function minecraft_but.core:menu/modifiers/core/glowing/config"}},{"text":"Glowing","bold":false,"color":"#46cb99","hoverEvent": {"action":"show_text","contents":[{"text":"Players or mobs glow, depending on your configuration. They can glow permanently or at an interval such as every minute.","color":"#ECEFF5"}]}}]

## Food gives you random potion effects (potion_food)
execute unless score potion_food minecraft_but.toggle matches 1 run tellraw @s [{"text":" [✖] ","bold":false,"color":"#FF0000","clickEvent":{"action":"run_command","value":"/function minecraft_but.core:menu/modifiers/core/potion_food/on"}},{"text":"     ","hoverEvent": {"action":"show_text","contents":[{"text":"Eating food gives you a random potion effect. You can configure this modifier to give a specific potion effect for each kind of food.","color":"#ECEFF5"}]}},{"text":"Food gives you random potion effects","bold":false,"color":"#38dc66","hoverEvent": {"action":"show_text","contents":[{"text":"Eating food gives you a random potion effect. You can configure this modifier to give a specific potion effect for each kind of food.","color":"#ECEFF5"}]}}]
...
execute unless score suspicious_injury minecraft_but.toggle matches 1 run tellraw @s [{"text":" [✖] ","bold":false,"color":"#FF0000","clickEvent":{"action":"run_command","value":"/function minecraft_but.core:menu/modifiers/core/suspicious_injury/on"}},{"text":"     ","hoverEvent": {"action":"show_text","contents":[{"text":"When you take damage, you get a random potion effect","color":"#ECEFF5"}]}},{"text":"Taking damage gives you a random effect","bold":false,"color":"#1cff00","hoverEvent": {"action":"show_text","contents":[{"text":"When you take damage, you get a random potion effect","color":"#ECEFF5"}]}}]


execute if score suspicious_injury minecraft_but.toggle matches 1 run tellraw @s [{"text":" [✔] ","bold":false,"color":"#3ED011","clickEvent":{"action":"run_command","value":"/function minecraft_but.core:menu/modifiers/core/suspicious_injury/off"}},{"text":"     ","hoverEvent": {"action":"show_text","contents":[{"text":"When you take damage, you get a random potion effect","color":"#ECEFF5"}]}},{"text":"Taking damage gives you a random effect","bold":false,"color":"#1cff00","hoverEvent": {"action":"show_text","contents":[{"text":"When you take damage, you get a random potion effect","color":"#ECEFF5"}]}}]
