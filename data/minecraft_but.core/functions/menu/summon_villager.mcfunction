#> minecraft_but.coreraft_but.core:menu/summon_villager
...
summon villager ~ ~100 ~ {NoAI:1b,Silent:1b,Offers:{},Tags:["minecraft_but","minecraft_but.menu","minecraft_but.menu.inminecraft_but.coreglobal.ignore"],Team:"minecraft_but.core.no_collision"}
