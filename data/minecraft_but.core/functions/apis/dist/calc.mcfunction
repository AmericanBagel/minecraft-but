#> minecraft_but.coreraft_but.core:apis/dist/calc
#
# Calculates the distance from origin, velocity of @s, or distance between @s and @p
# @api
#
# Source: https://github.com/rx-modules/gists/blob/main/dist/dist.mcfunction
# License: MIT
