#> minecraft_but.coreraft_but.core:modifiers/config
# Update configs for modifiers
# @within minecraft_but.coreraft_but.core:load
# @context root

#> Schedule config in one second
schedule function minecraft_but.coreraft_but.core:modifiers/config 10t
...
#> Modifiers
function minecraft_but.coreraft_but.core:modifiers/degradation/config
function minecraft_but.coreraft_but.core:modifiers/herbivore/config
function minecraft_but.coreraft_but.core:modifiers/carnivore/config