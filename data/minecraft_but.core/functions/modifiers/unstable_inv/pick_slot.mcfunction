#> minecraft_but.coreraft_but.core:modifiers/unstable_inv/pick_slot
...
#
# @context player
# @within minecraft_but.coreraft_but.core:modifiers/unstable_inv/main
# @output
...
execute if score $index minecraft_but.unstable_inv matches 1.. run minecraft_but.coreion minecraft_but.core:modifiers/unstable_inv/iterate
...
# 13 commands
execute if score $slot minecraft_but.unstable_inv matches -106..8 run minecraft_but.coreion minecraft_but.core:modifiers/unstable_inv/slot/hotbar

# 15 commands
execute if score $slot minecraft_but.unstable_inv matches 9..35 run minecraft_but.coreion minecraft_but.core:modifiers/unstable_inv/slot/inventory

# 7 commands
execute if score $slot minecraft_but.unstable_inv matches 100..103 run minecraft_but.coreion minecraft_but.core:modifiers/unstable_inv/slot/armor
