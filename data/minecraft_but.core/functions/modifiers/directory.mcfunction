#> minecraft_but.coreraft_but.core:modifiers/directory
# Main modifier function for runnig and managing other modifiers
# @within minecraft_but.coreraft_but.core:main
# @context root
# @input
...
execute if score mode minecraft_but.config matches 1 run minecraft_but.coreion minecraft_but.core:modifiers/manual

#> 🎲 If random mode (2) is enabled, run random function
execute if score mode minecraft_but.config matches 2 run minecraft_but.coreion minecraft_but.core:random

#> 🏃 If speedrun mode (3) is enabled, run speedrun function
execute if score mode minecraft_but.config matches 3 run minecraft_but.coreion minecraft_but.core:modifiers/speedrun
