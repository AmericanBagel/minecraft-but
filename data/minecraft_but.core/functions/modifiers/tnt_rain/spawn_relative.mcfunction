#> minecraft_but.coreraft_but.core:modifiers/tnt_rain/spawn_relative
# 
# Spawn tnts above player
#
# @context tnt marker
# @within minecraft_but.coreraft_but.core:modifiers/tnt_rain/relative
# @output
...
#> Get Y offset
#function minecraft_but.coreraft_but.core:modifiers/tnt_rain/get_offset
...
#execute positioned ~ ~10 ~ run function minecraft_but.coreraft_but.core:modifiers/tnt_rain/rain
#
## tnt particles
...
# Run tnt spawning function
execute at @s run function minecraft_but.coreraft_but.core:modifiers/tnt_rain/rain
