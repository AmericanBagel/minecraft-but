#> minecraft_but.coreraft_but.core:modifiers/tnt_rain/mark_destroy
...
execute as @s[ tag=minecraft_but.tnt_rain.destroy ] run minecraft_but.coreion minecraft_but.core:modifiers/tnt_rain/destroy_tnt
