#> minecraft_but.coreraft_but.core:modifiers/tnt_rain/main
...
execute as @e[type=tnt,tag=minecraft_but.tnt_rain,nbt={Fuse:1s}, tag=!global.ignore] at @s run minecraft_but.coreion minecraft_but.core:modifiers/tnt_rain/replace_tnt
...
# Start the loop
function minecraft_but.coreraft_but.core:modifiers/tnt_rain/loop