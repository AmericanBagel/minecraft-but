#> minecraft_but.coreraft_but.core:modifiers/tnt_rain/spawn_sky
# Spawn tnts from the sky
# @context player
# @within minecraft_but.coreraft_but.core:modifiers/tnt_rain/loop
...
execute as @e[ type=marker, name="minecraft_but.tnt_rain.spawner" ] at @s positioned ~ 319 ~ run minecraft_but.coreion minecraft_but.core:modifiers/tnt_rain/rain
