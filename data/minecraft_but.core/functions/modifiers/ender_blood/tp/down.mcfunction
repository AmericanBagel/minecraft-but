#> minecraft_but.coreraft_but.core:modifiers/ender_blood/tp/down
# Recursively search down until limit is reached or solid ground is found
# @within minecraft_but.coreraft_but.core:modifiers/ender_blood/tp/start_down
...
execute if score $limit minecraft_but.ender_blood matches 1.. unless score $grounded minecraft_but.ender_blood matches 1.. positioned ~ ~-minecraft_but.corerun function minecraft_but.core:modifiers/ender_blood/tp/down

# If solid ground has been found, tp
execute if score $grounded minecraft_but.ender_blood matches 1.. run minecraft_but.coreion minecraft_but.core:modifiers/ender_blood/tp/tp