#> minecraft_but.core:modifiers/ender_blood/tp/start_down
#
# Start marching down to find solid ground below
#
# @within minecraft_but.core:modifiers/ender_blood/start_search
...
function minecraft_but.core:modifiers/ender_blood/tp/down