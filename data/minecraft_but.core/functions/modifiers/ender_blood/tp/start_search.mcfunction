#> minecraft_but.coreraft_but.core:modifiers/ender_blood/tp/start_search
...
#
# @within minecraft_but.coreraft_but.core:modifiers/ender_blood/tp/tp_init
# @context player
...
# If grounded, tp
execute at @e[ tag=minecraft_but.ender_blood.marker ] if score $grounded minecraft_but.ender_blood matchminecraft_but.corerun function minecraft_but.core:modifiers/ender_blood/tp/tp

#> If not grounded, search down
execute at @e[ tag=minecraft_but.ender_blood.marker ] unless score $grounded minecraft_but.ender_blood matchminecraft_but.corerun function minecraft_but.core:modifiers/ender_blood/tp/start_down