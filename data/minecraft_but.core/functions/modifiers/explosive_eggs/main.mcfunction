...
execute as @e[ type=egg, tag=!minecraft_but.eeMarked, tag=!global.ignore ] at @s run function minecraft_but.core:modifiers/explosive_eggs/mark
execute as @e[ type=area_effect_cloud, name="minecraft_but.eeMarker" ] at @s run function minecraft_but.core:modifiers/explosive_eggs/tick