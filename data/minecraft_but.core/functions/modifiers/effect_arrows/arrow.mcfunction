...
##data modify storage minecraft_but.core:effect_arrows CustomPotionEffects set value [{Id:32b,Amplifier:1b,Duration:20}]
##
##data modify storage minecraft_but.core:effect_arrows CustomPotionEffects[0].Id set value 10
##data modify storage minecraft_but.core:effect_arrows CustomPotionEffects[0].Amplifier set value 10b
##data modify storage minecraft_but.core:effect_arrows CustomPotionEffects[0].Duration set value 30
##
##data modify entity @s CustomPotionEffects[0] set from storage minecraft_but.core:effect_arrows CustomPotionEffects[0]