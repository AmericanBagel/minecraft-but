#> minecraft_but.core:modifiers/effect_arrows/main
...
execute as @e[type=arrow,tag=!minecraft_but.effect_arrows] at @s run function minecraft_but.core:modifiers/effect_arrows/arrow