...
function minecraft_but.core:modifiers/vengeful_slimes/rng/lcg
...
execute if score minecraft_but.vsTemp minecraft_but.vsMath matches ..-1 run function minecraft_but.core:modifiers/vengeful_slimes/rng/zprivate/next_int
