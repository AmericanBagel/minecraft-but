#> minecraft_but.coreraft_but.core:modifiers/mermaid/in_water
...
#> Sound effects
# Return to water SFX
execute unless score mermaid.sfx minecraft_but.config matches 0 run minecraft_but.coreion minecraft_but.core:modifiers/mermaid/relief_sound
