#> minecraft_but.coreraft_but.core:modifiers/mermaid/out_of_water
...
execute unless score mermaid.warning minecraft_but.config matches 0 unless pminecraft_but.coreate minecraft_but.coreminecraft_but.coreing run function minecraft_but.core:modifiers/mermaid/water_warning
execute unless score mermaid.warning minecraft_but.config matches 0 unless score mermaid.rain minecraft_but.config matchminecraft_but.coreif predicate minecraftminecraft_but.corecore:raining run function minecraft_but.core:modifiers/mermaid/rain_warning
execute if score mermaid.rain minecraft_but.config matches 0 run minecraft_but.coreion minecraft_but.core:modifiers/mermaid/water_warning

title @s times 0 1 1

#> Danger tone
execute unless score mermaid.sfx minecraft_but.config matches 0 if score $tick minecraft_but.mermaid matchesminecraft_but.corerun function minecraft_but.core:modifiers/mermaid/warning_sound
