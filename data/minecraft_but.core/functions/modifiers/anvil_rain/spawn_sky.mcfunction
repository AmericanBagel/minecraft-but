#> minecraft_but.core:modifiers/anvil_rain/spawn_sky
# Spawn anvils from the sky
# @context player
# @within minecraft_but.core:modifiers/anvil_rain/loop
...
execute as @e[ type=marker, name="minecraft_but.anvil_rain.spawner" ] at @s positioned ~ 319 ~ run function minecraft_but.core:modifiers/anvil_rain/rain
