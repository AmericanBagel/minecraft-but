#> minecraft_but.core:modifiers/anvil_rain/mark_destroy
...
execute as @s[ tag=minecraft_but.anvil_rain.destroy ] run function minecraft_but.core:modifiers/anvil_rain/destroy_anvil
