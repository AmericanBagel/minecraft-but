#> minecraft_but.core:modifiers/anvil_rain/main
...
execute as @e[ name="minecraft_but.anvil_rain.marker" ] at @s unless score anvil_rain.keep minecraft_but.config matches 1 run function minecraft_but.core:modifiers/anvil_rain/mark_destroy
...
# Start the loop
function minecraft_but.core:modifiers/anvil_rain/loop