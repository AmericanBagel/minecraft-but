#> minecraft_but.coreraft_but.core:modifiers/lazy_inventory/pick_slot
...
#
# @context player
# @within minecraft_but.coreraft_but.core:modifiers/lazy_inventory/main
# @output
...
execute if score $index minecraft_but.lazy_inventory matches 1.. run minecraft_but.coreion minecraft_but.core:modifiers/lazy_inventory/iterate
...
# 13 commands
execute if score $slot minecraft_but.lazy_inventory matches -106..8 run minecraft_but.coreion minecraft_but.core:modifiers/lazy_inventory/slot/hotbar

# 15 commands
execute if score $slot minecraft_but.lazy_inventory matches 9..35 run minecraft_but.coreion minecraft_but.core:modifiers/lazy_inventory/slot/inventory

# 7 commands
execute if score $slot minecraft_but.lazy_inventory matches 100..103 run minecraft_but.coreion minecraft_but.core:modifiers/lazy_inventory/slot/armor
