...
playsound minecraft:entity.spider.ambient hostile @a[ tag=!minecraft_but.blacklist, tag=!global.ignore ] ~ ~ ~ 1 0.35
scoreboard players set @s minecraft_but.webCdwn 0