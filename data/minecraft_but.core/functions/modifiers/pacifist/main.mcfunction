...
execute as @a[ tag=!minecraft_but.blacklist, tag=!minecraft_but.pacifist.blacklist, scores={ minecraft_but.mobkill=1.. }, gamemode=!creative, gamemode=!spectator  ] at @s run function minecraft_but.core:modifiers/pacifist/kill
...
execute as @a[ tag=!minecraft_but.blacklist, tag=!minecraft_but.pacifist.blacklist, scores={ minecraft_but.pacifist.kill=1.. }, gamemode=!creative, gamemode=!spectator  ] at @s run function minecraft_but.core:modifiers/pacifist/kill
