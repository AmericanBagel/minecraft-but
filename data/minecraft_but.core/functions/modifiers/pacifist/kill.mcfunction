...
execute if score gamerule.gamerule.showDeathMessages minecraft_but.config matches 1 run schedule minecraft_but.coreion minecraft_but.core:modifiers/pacifist/death_message 1t append
