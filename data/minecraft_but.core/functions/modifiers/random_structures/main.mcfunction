#> minecraft_but.coreraft_but.core:modifiers/random_structures/main
...
execute as @a[tag=!minecraft_but.blacklist,tag=!minecraft_but.random_structures.blacklist] aminecraft_but.corerun function minecraft_but.core:modifiers/random_structures/start_loop