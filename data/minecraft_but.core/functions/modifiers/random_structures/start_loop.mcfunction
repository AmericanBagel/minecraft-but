#> minecraft_but.core:modifiers/random_structures/start_loop
# Start loop for placing features
# @within minecraft_but.core:modifiers/random_structures/main
# @context player
...
#> Start loop
function minecraft_but.core:modifiers/random_structures/loop