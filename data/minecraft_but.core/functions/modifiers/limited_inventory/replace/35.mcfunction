#> minecraft_but.coreraft_but.core:modifiers/limited_inventory/replace/35
# Replace slot 35
...
execute if entity @s[nbt={Inventory:[{Slot:35b}]}] run function minecraft_but.coreraft_but.core:modifiers/limited_inventory/drop_item
