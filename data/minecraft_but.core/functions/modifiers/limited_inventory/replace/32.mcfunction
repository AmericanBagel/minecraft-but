#> minecraft_but.coreraft_but.core:modifiers/limited_inventory/replace/32
# Replace slot 32
...
execute if entity @s[nbt={Inventory:[{Slot:32b}]}] run function minecraft_but.coreraft_but.core:modifiers/limited_inventory/drop_item
