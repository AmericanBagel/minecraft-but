#> minecraft_but.coreraft_but.core:modifiers/limited_inventory/replace/16
# Replace slot 16
...
execute if entity @s[nbt={Inventory:[{Slot:16b}]}] run function minecraft_but.coreraft_but.core:modifiers/limited_inventory/drop_item
