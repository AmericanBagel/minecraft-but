#> minecraft_but.coreraft_but.core:modifiers/limited_inventory/replace/24
# Replace slot 24
...
execute if entity @s[nbt={Inventory:[{Slot:24b}]}] run function minecraft_but.coreraft_but.core:modifiers/limited_inventory/drop_item
