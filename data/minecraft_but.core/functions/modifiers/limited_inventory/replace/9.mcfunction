#> minecraft_but.coreraft_but.core:modifiers/limited_inventory/replace/9
# Replace slot 9
...
execute if entity @s[nbt={Inventory:[{Slot:9b}]}] run function minecraft_but.coreraft_but.core:modifiers/limited_inventory/drop_item
