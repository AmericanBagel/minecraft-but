#> minecraft_but.core:modifiers/limited_inventory/replace/17
# Replace slot 17
...
execute if entity @s[nbt={Inventory:[{Slot:17b}]}] run function minecraft_but.core:modifiers/limited_inventory/drop_item
