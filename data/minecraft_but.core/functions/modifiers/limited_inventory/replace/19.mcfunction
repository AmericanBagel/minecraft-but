#> minecraft_but.coreraft_but.core:modifiers/limited_inventory/replace/19
# Replace slot 19
...
execute if entity @s[nbt={Inventory:[{Slot:19b}]}] run function minecraft_but.coreraft_but.core:modifiers/limited_inventory/drop_item
