#> minecraft_but.coreraft_but.core:modifiers/limited_inventory/replace/12
# Replace slot 12
...
execute if entity @s[nbt={Inventory:[{Slot:12b}]}] run function minecraft_but.coreraft_but.core:modifiers/limited_inventory/drop_item
