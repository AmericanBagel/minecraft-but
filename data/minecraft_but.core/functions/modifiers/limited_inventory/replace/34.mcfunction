#> minecraft_but.coreraft_but.core:modifiers/limited_inventory/replace/34
# Replace slot 34
...
execute if entity @s[nbt={Inventory:[{Slot:34b}]}] run function minecraft_but.coreraft_but.core:modifiers/limited_inventory/drop_item
