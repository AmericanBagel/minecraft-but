#> minecraft_but.core:modifiers/limited_inventory/replace/18
# Replace slot 18
...
execute if entity @s[nbt={Inventory:[{Slot:18b}]}] run function minecraft_but.core:modifiers/limited_inventory/drop_item
