#> minecraft_but.coreraft_but.core:modifiers/limited_inventory/replace/27
# Replace slot 27
...
execute if entity @s[nbt={Inventory:[{Slot:27b}]}] run function minecraft_but.coreraft_but.core:modifiers/limited_inventory/drop_item
