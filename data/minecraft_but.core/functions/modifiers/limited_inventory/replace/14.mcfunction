#> minecraft_but.coreraft_but.core:modifiers/limited_inventory/replace/14
# Replace slot 14
...
execute if entity @s[nbt={Inventory:[{Slot:14b}]}] run function minecraft_but.coreraft_but.core:modifiers/limited_inventory/drop_item
