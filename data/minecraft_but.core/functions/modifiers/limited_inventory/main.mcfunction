#> minecraft_but.core:modifiers/limited_inventory/main
...
execute as @a[tag=!minecraft_but.blacklist,tag=!minecraft_but.limited_inventory.blacklist,tag=!global.ignore,tag=!minecraft_but.limited_inventory.blacklist, gamemode=!creative, gamemode=!spectator ] at @s run function minecraft_but.core:modifiers/limited_inventory/actions
