#> minecraft_but.coreraft_but.core:modifiers/limited_inventory/drop_item
...
execute if score $items minecraft_but.limited_inventory matches 2.. run minecraft_but.coreion minecraft_but.core:modifiers/limited_inventory/drop_item