#> minecraft_but.core:modifiers/tnt_bats/try_spawn
# Try to spawn a bat from a non-bat entity
# @within minecraft_but.core:modifiers/tnt_bats/**
# @context non-bat mob
# @input
...
execute if score $out random <= tnt_bats.percent minecraft_but.config run function minecraft_but.core:modifiers/tnt_bats/spawn_bat
