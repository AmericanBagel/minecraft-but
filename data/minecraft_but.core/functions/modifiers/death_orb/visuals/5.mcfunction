#> minecraft_but.coreraft_but.core:modifiers/death_orb/visuals/5
...
execute at @s facing entity @p[ tag=minecraft_but.death_orb.this] eyes run particle portal ^ ^ ^1 0 0 0 1 20 force

execute at @s facing entity @p[ tag=minecraft_but.death_orb.this] eyes run particle reverse_portal ^ ^ ^ 0 0 0 .25 20 force