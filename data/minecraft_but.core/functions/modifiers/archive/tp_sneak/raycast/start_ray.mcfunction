##> minecraft_but.coreraft_but.core:modifiers/tp_sneak/raycast/start_ray
##
...
## @context raycast
##
## @within minecraft_but.coreraft_but.core:modifiers/tp_sneak/main
#
...
#execute positioned ~ ~.225 ~ anchored eyes run function minecraft_but.coreraft_but.core:modifiers/tp_sneak/raycast/ray
