##> minecraft_but.coreraft_but.core:modifiers/tp_sneak/main
##
## Minecraft, but you teleport where you sneak.
##
## @context teleport sneak
##
## @within minecraft_but.coreraft_but.core:modifiers/tp_sneak/**
...
#
#execute as @a[tag=!minecraft_but.blacklist] at @s if score @s minecraft_but.tp_sneak.sneak matches 1.. if score @s minecraft_but.tp_sneak.timinecraft_but.coreatches 0 run function minecraft_but.core:modifiers/tp_sneak/raycast/start_ray
