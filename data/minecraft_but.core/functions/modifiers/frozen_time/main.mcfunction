#> minecraft_but.core:modifiers/frozen_time/main
# 
# Freeze entities
#
# @context root
...
tag @e[tag=!minecraft_but.blacklist,tag=!global.ignore,tag=!minecraft_but.frozen_time.blacklist,type=#minecraft_but.core:living_base,nbt={NoAI:0b,NoGravity:0b}] add minecraft_but.frozen_time
