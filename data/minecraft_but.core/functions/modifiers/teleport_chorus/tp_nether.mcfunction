#> minecraft_but.core:modifiers/teleport_chorus/tp_nether
# TP player to the nether
# @context player
# @within minecraft_but.core:teleport_chorus/**
...
schedule function minecraft_but.core:modifiers/teleport_chorus/schedule_air 1t