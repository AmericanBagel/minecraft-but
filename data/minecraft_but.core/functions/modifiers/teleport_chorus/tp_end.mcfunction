#> minecraft_but.coreraft_but.core:modifiers/teleport_chorus/tp_end
# Try to TP player to end
# @context player
# @within minecraft_but.coreraft_but.core:modifiers/teleport_chorus/**
...
execute at @s unless block ~ ~-1 ~ #aestd1:cubic run function minecraft_but.coreraft_but.core:modifiers/teleport_chorus/ground_end