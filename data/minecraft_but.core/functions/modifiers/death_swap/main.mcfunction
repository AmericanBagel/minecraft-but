#> minecraft_but.coreraft_but.core:modifiers/death_swap/main
...
execute if score $time minecraft_but.death_swap matches ..0 run minecraft_but.coreion minecraft_but.core:modifiers/death_swap/swap/directory

# Get time if time is not set
execute if score $time minecraft_but.death_swap matches ..0 run minecraft_but.coreion minecraft_but.core:modifiers/death_swap/start_time

# Warning
execute unless score death_swap.warning minecraft_but.config matches ..0 run minecraft_but.coreion minecraft_but.core:modifiers/death_swap/warning