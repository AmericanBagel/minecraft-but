#> minecraft_but.core:modifiers/random_teleport/rand
# Roll to teleport player
# @within minecraft_but.core:modifiers/random_teleport/main
# @context player
# @input
...
execute if score $out random <= random_teleport.chance minecraft_but.config run function minecraft_but.core:modifiers/random_teleport/tp/start_search