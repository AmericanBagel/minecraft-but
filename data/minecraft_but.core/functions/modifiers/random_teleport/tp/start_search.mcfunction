#> minecraft_but.coreraft_but.core:modifiers/random_teleport/tp/start_search
...
#
# @within minecraft_but.coreraft_but.core:modifiers/random_teleport/tp/tp_init
# @context player
...
# If grounded, tp
execute at @e[ tag=minecraft_but.random_teleport.marker ] if score $grounded minecraft_but.random_teleport matchminecraft_but.corerun function minecraft_but.core:modifiers/random_teleport/tp/tp

#> If not grounded, search down
execute at @e[ tag=minecraft_but.random_teleport.marker ] unless score $grounded minecraft_but.random_teleport matchminecraft_but.corerun function minecraft_but.core:modifiers/random_teleport/tp/start_down