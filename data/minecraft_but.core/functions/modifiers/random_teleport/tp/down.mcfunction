...
execute if score $limit minecraft_but.random_teleport matches 1.. unless score $grounded minecraft_but.random_teleport matches 1.. positioned ~ ~-.5 ~ run function minecraft_but.core:modifiers/random_teleport/tp/down

# If solid ground has been found, tp
execute if score $grounded minecraft_but.random_teleport matches 1.. run function minecraft_but.core:modifiers/random_teleport/tp/tp