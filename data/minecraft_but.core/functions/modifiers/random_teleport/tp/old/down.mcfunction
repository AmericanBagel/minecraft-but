...
execute if score $limit minecraft_but.random_teleport matches 1.. if block ~ ~-1 ~ #aestd1:air positioned ~ ~-1 ~ run function minecraft_but.core:modifiers/random_teleport/tp/down
...
execute if score $limit minecraft_but.random_teleport matches ..0 run function minecraft_but.core:modifiers/random_teleport/tp/up_from_down