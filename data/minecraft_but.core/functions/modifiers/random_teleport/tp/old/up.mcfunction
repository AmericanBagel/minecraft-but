...
# @within minecraft_but.coreraft_but.core:modifiers/random_teleport/tp/start_up
...
execute if score $limit minecraft_but.random_teleport matches 1.. if block ~ ~1 ~ #aestd1:air positioned ~ ~1 ~ run minecraft_but.coreion minecraft_but.core:modifiers/random_teleport/tp/up
...
execute if score $limit minecraft_but.random_teleport matches ..0 run minecraft_but.coreion minecraft_but.core:modifiers/random_teleport/tp/up_from_up