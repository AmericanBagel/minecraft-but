#> minecraft_but.core:modifiers/random_teleport/tp/start_up
#
...
execute at @e[tag=minecraft_but.random_teleport.marker] run function minecraft_but.core:modifiers/random_teleport/tp/up