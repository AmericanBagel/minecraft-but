#> minecraft_but.core:modifiers/random_teleport/tp/restart
# Ground was not found, so restart by randomly teleporting around again and retrying
# @within minecraft_but.core:modifiers/random_teleport/compare
# @context player
...
function minecraft_but.core:modifiers/random_teleport/tp/start_search