#> minecraft_but.coreraft_but.core:modifiers/toxic_water/out_of_water
...
#> Sound effects
# Return to water SFX
execute unless score toxic_water.sfx minecraft_but.config matches 0 run minecraft_but.coreion minecraft_but.core:modifiers/toxic_water/relief_sound
