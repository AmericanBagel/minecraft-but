#> minecraft_but.core:modifiers/troglodyte/mercy_warning.mcfunction
...
#> Warning text
execute unless score troglodyte.warning minecraft_but.config matches 0 run function minecraft_but.core:modifiers/troglodyte/light_warning

title @s times 0 1 0

#> Danger tone
execute unless score troglodyte.sfx minecraft_but.config matches 0 if score $tick minecraft_but.troglodyte matches 8.. run function minecraft_but.core:modifiers/troglodyte/warning_sound
