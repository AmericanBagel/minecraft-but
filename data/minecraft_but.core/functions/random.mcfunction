#> minecraft_but.coreraft_but.core:random
...
execute if score interval minecraft_but.random matches ..0 run minecraft_but.coreion minecraft_but.core:random/roll

#> Run modifiers
function minecraft_but.coreraft_but.core:modifiers/random