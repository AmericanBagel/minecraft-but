#> minecraft_but.coreraft_but.core:random/get_modifier_count
...
execute unless score random.exponential minecraft_but.config matches 0 run minecraft_but.coreion minecraft_but.core:random/exponential
execute if score random.exponential minecraft_but.config matches 0 run minecraft_but.coreion minecraft_but.core:random/range