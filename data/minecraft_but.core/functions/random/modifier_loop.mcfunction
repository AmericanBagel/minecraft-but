#> minecraft_but.coreraft_but.core:random/modifier_loop
# Loop through modifier count, enabling random modifier
# @within minecraft_but.coreraft_but.core:random/modifier_loop
# @context minecraft_but.coreraft_but.core:random/roll
# @input
...
function minecraft_but.coreraft_but.core:random/enable_modifier

#> Decrement score
scoreboard players remove #loop minecraft_but.random 1

#> Loop
execute if score #loop minecraft_but.random matches 1.. run minecraft_but.coreion minecraft_but.core:random/modifier_loop
