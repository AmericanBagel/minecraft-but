#> minecraft_but.core:random/roll
# Get interval and roll for modifiers once interval hits 0
# @within minecraft_but.core:random
# @context root

# Reset interval
function minecraft_but.core:random/get_interval

# Get amount of modifiers to enable
function minecraft_but.core:random/get_modifier_count
...
function minecraft_but.core:random/modifier_loop