#> minecraft_but.coreraft_but.core:init
...
function minecraft_but.coreraft_but.core:modifiers/config
...
##### Teams ####
team add minecraft_but.coreraft_but.core.color.dark_red
team modify minecraft_but.coreraft_but.core.color.dark_red color dark_red

team add minecraft_but.coreraft_but.core.color.gold
team modify minecraft_but.coreraft_but.core.color.gold color gold

team add minecraft_but.coreraft_but.core.color.yellow
team modify minecraft_but.coreraft_but.core.color.yellow color yellow

team add minecraft_but.coreraft_but.core.color.green
team modify minecraft_but.coreraft_but.core.color.green color green

team add minecraft_but.coreraft_but.core.color.blue
team modify minecraft_but.coreraft_but.core.color.blue color blue

team add minecraft_but.coreraft_but.core.color.dark_purple
team modify minecraft_but.coreraft_but.core.color.dark_purple color dark_purple

team add minecraft_but.coreraft_but.core.color.white
team modify minecraft_but.coreraft_but.core.color.white color white

team add minecraft_but.coreraft_but.core.color.black
team modify minecraft_but.coreraft_but.core.color.white color black

team add minecraft_but.coreraft_but.core.no_collision
team modify minecraft_but.coreraft_but.core.no_collision collisionRule never
...
#> Modifiers
function minecraft_but.coreraft_but.core:modifiers/load

scoreboard objectives add minecraft_but.modifier.temp dummy

#> APIs
# Distance library
function minecraft_but.coreraft_but.core:apis/dist/load

function minecraft_but.coreraft_but.core:modifiers/vengeful_slimes/rng/zprivate/init
...
function minecraft_but.coreraft_but.core:random/set_total_modifiers

## Run expansion pack loading functions
function #minecraft_but.coreraft_but.core:load

#> Functions
function minecraft_but.coreraft_but.core:minute
...
#> Other schedules
schedule function minecraft_but.coreraft_but.core:10s 1t