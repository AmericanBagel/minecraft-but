#> minecraft_but.coreraft_but.core:complete_uninstall
# Completely uninstall pack
# Remove scoreboards, clean up tags, remove entities
# @user

#> Run uninstall for modifiers
function minecraft_but.coreraft_but.core:modifiers/uninstall

#> Run uninstall for expansion packs
function #minecraft_but.coreraft_but.core:uninstall

# Remove teams
team remove minecraft_but.coreraft_but.core.color.dark_red
team remove minecraft_but.coreraft_but.core.color.gold
team remove minecraft_but.coreraft_but.core.color.yellow
team remove minecraft_but.coreraft_but.core.color.green
team remove minecraft_but.coreraft_but.core.color.blue
team remove minecraft_but.coreraft_but.core.color.dark_purple
team remove minecraft_but.coreraft_but.core.color.white
team remove minecraft_but.coreraft_but.core.color.black
team remove minecraft_but.coreraft_but.core.no_collision
...
tp @e[tag=minecraft_but.coreraft_but.core] ~ -1000 ~
tp @e[tag=minecraft_but] ~ -1000 ~

#> APIs
# Distance library
function minecraft_but.coreraft_but.core:apis/dist/uninstall
