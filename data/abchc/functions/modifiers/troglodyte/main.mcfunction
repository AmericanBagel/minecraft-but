...
execute as @a[ tag=!abch.blacklist ] at @s if predicate abchc:troglodyte/13 run effect give @s blindness 1 0 true
...
execute as @a[ tag=!abch.blacklist ] at @s if predicate abchc:troglodyte/14 run effect give @s blindness 1 2 true
...
execute as @a[ tag=!abch.blacklist ] at @s if predicate abchc:troglodyte/15 run effect give @s blindness 1 2 true
