#> abchc:modifiers/troglodyte/peaceful
# Peaceful difficulty for troglodyte
...
execute as @a[ tag=!abch.blacklist ] at @s if predicate abchc:troglodyte/0 run effect give @s speed 2 0 true
...
execute as @a[ tag=!abch.blacklist ] at @s if predicate abchc:troglodyte/2 run effect give @s night_vision 1 0 true

execute as @a[ tag=!abch.blacklist ] at @s if predicate abchc:troglodyte/3 run effect give @s night_vision 1 0 true
execute as @a[ tag=!abch.blacklist ] at @s if predicate abchc:troglodyte/4 run effect give @s night_vision 1 0 true
execute as @a[ tag=!abch.blacklist ] at @s if predicate abchc:troglodyte/5 run effect give @s night_vision 1 0 true
execute as @a[ tag=!abch.blacklist ] at @s if predicate abchc:troglodyte/6 run effect give @s night_vision 1 0 true
execute as @a[ tag=!abch.blacklist ] at @s if predicate abchc:troglodyte/7 run effect give @s night_vision 1 0 true

execute as @a[ tag=!abch.blacklist ] at @s if predicate abchc:troglodyte/8 run effect give @s night_vision 1 0 true
...
execute as @a[ tag=!abch.blacklist ] at @s if predicate abchc:troglodyte/9 run effect give @s night_vision 1 0 true

execute as @a[ tag=!abch.blacklist ] at @s if predicate abchc:troglodyte/10 run effect give @s weakness 1 1 true
execute as @a[ tag=!abch.blacklist ] at @s if predicate abchc:troglodyte/10 run effect give @s night_vision 1 0 true
...
execute as @a[ tag=!abch.blacklist ] at @s if predicate abchc:troglodyte/12 run effect give @s slowness 1 0 true
...
execute as @a[ tag=!abch.blacklist ] at @s if predicate abchc:troglodyte/13 run effect give @s slowness 1 0 true
...
execute as @a[ tag=!abch.blacklist ] at @s if predicate abchc:troglodyte/14 run effect give @s slowness 1 0 true
execute as @a[ tag=!abch.blacklist ] at @s if predicate abchc:troglodyte/14 run effect give @s weakness 1 2 true
execute as @a[ tag=!abch.blacklist ] at @s if predicate abchc:troglodyte/14 run effect give @s mining_fatigue 1 0 true
#execute as @a[ tag=!abch.blacklist ] at @s if predicate abchc:troglodyte/14 run effect give @s nausea 4 0 true
execute as @a[ tag=!abch.blacklist ] at @s if predicate abchc:troglodyte/14 run effect give @s wither 1 2 true

execute as @a[ tag=!abch.blacklist ] at @s if predicate abchc:troglodyte/15 run effect give @s slowness 1 0 true
execute as @a[ tag=!abch.blacklist ] at @s if predicate abchc:troglodyte/15 run effect give @s weakness 1 1 true
execute as @a[ tag=!abch.blacklist ] at @s if predicate abchc:troglodyte/15 run effect give @s mining_fatigue 1 1 true
#execute as @a[ tag=!abch.blacklist ] at @s if predicate abchc:troglodyte/15 run effect give @s nausea 4 0 true
execute as @a[ tag=!abch.blacklist ] at @s if predicate abchc:troglodyte/15 run effect give @s wither 1 3 true
execute as @a[ tag=!abch.blacklist ] at @s if predicate abchc:troglodyte/15 run effect give @s instant_damage 1 0 true