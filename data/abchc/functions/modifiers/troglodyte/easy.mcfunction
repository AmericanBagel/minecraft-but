...
execute as @a[ tag=!abch.blacklist ] at @s if predicate abchc:troglodyte/14 run effect give @s slowness 1 1 true
...
execute as @a[ tag=!abch.blacklist ] at @s if predicate abchc:troglodyte/14 run effect give @s wither 1 3 true

execute as @a[ tag=!abch.blacklist ] at @s if predicate abchc:troglodyte/15 run effect give @s slowness 1 1 true
...
execute as @a[ tag=!abch.blacklist ] at @s if predicate abchc:troglodyte/15 run effect give @s wither 1 5 true
