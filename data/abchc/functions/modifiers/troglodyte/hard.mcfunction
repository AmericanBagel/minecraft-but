...
execute as @a[ tag=!abch.blacklist ] at @s if predicate abchc:troglodyte/13 run effect give @s wither 1 2 true
...
execute as @a[ tag=!abch.blacklist ] at @s if predicate abchc:troglodyte/13 run effect give @s wither 1 4 true
...
execute as @a[ tag=!abch.blacklist ] at @s if predicate abchc:troglodyte/13 run effect give @s wither 1 6 true
...
execute as @a[ tag=!abch.blacklist ] at @s if predicate abchc:troglodyte/14 run effect give @s wither 1 8 true
