#> abchc:modifiers/teleport_chorus/tp_end
# Try to TP player to end
# @context player
# @within abchc:modifiers/teleport_chorus/**
...
execute at @s unless block ~ ~-1 ~ #aestd1:cubic run function abchc:modifiers/teleport_chorus/ground_end