...
# @within abchc:modifiers/random_teleport/tp/start_up
...
execute if score $limit abch.random_teleport matches 1.. if block ~ ~1 ~ #aestd1:air positioned ~ ~1 ~ run function abchc:modifiers/random_teleport/tp/up
...
execute if score $limit abch.random_teleport matches ..0 run function abchc:modifiers/random_teleport/tp/up_from_up