...
execute if block ~ ~-1 ~ #aestd1:all_but_air if block ~ ~ ~ #aestd1:air if block ~ ~1 ~ #aestd1:air run scoreboard players set $down_grounded abch.random_teleport 1

# If limit hasn't been reached and solid ground has not been found, run this function again but positioned down
execute if score $limit abch.random_teleport matches 1.. unless score $down_grounded abch.random_teleport matches 1.. positioned ~ ~-1 ~ run function abchc:modifiers/random_teleport/tp/down
...
execute if score $down_grounded abch.random_teleport matches 1.. run summon marker ~ ~ ~ {Tags:["abch","abch.random_teleport","abch.random_teleport.down"]}

# Start searching up to compare
execute if score $down_grounded abch.random_teleport matches 1.. run function abchc:modifiers/random_teleport/tp/start_up

# If solid ground wasn't found, reset position and search up
execute if score $limit abch.random_teleport matches ..0 run function abchc:modifiers/random_teleport/tp/start_up