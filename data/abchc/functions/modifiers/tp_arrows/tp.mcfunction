...
execute as @a[ tag=!abch.blacklist, tag=!global.ignore ] store result score @s abch.tp_arrows.UUID1 run data get entity @s UUID[0]
execute as @a[ tag=!abch.blacklist, tag=!global.ignore ] store result score @s abch.tp_arrows.UUID2 run data get entity @s UUID[1]
execute as @a[ tag=!abch.blacklist, tag=!global.ignore ] store result score @s abch.tp_arrows.UUID3 run data get entity @s UUID[2]
execute as @a[ tag=!abch.blacklist, tag=!global.ignore ] store result score @s abch.tp_arrows.UUID4 run data get entity @s UUID[3]
