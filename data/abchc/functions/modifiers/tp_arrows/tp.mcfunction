...
execute as @a store result score @s abch.tpaUUID1 run data get entity @s UUID[0]
execute as @a store result score @s abch.tpaUUID2 run data get entity @s UUID[1]
execute as @a store result score @s abch.tpaUUID3 run data get entity @s UUID[2]
execute as @a store result score @s abch.tpaUUID4 run data get entity @s UUID[3]

execute as @a at @e[type=arrow,nbt={inGround:1b}] if entity @e[type=arrow,nbt={inGround:1b}] if score @s abch.tpaUUID1 = @e[type=arrow,limit=1,sort=nearest] abch.tpaUUID1 if score @s abch.tpaUUID2 = @e[type=arrow,limit=1,sort=nearest] abch.tpaUUID2 if score @s abch.tpaUUID3 = @e[type=arrow,limit=1,sort=nearest] abch.tpaUUID3 if score @s abch.tpaUUID4 = @e[type=arrow,limit=1,sort=nearest] abch.tpaUUID4 at @s run particle portal ~ ~.5 ~ 0 0.25 0 1 30 normal
execute as @a at @e[type=arrow,nbt={inGround:1b}] if entity @e[type=arrow,nbt={inGround:1b}] if score @s abch.tpaUUID1 = @e[type=arrow,limit=1,sort=nearest] abch.tpaUUID1 if score @s abch.tpaUUID2 = @e[type=arrow,limit=1,sort=nearest] abch.tpaUUID2 if score @s abch.tpaUUID3 = @e[type=arrow,limit=1,sort=nearest] abch.tpaUUID3 if score @s abch.tpaUUID4 = @e[type=arrow,limit=1,sort=nearest] abch.tpaUUID4 run tp @s ~ ~ ~ 
...
execute as @a at @e[type=arrow,nbt={inGround:1b}] if entity @e[type=arrow,nbt={inGround:1b}] if score @s abch.tpaUUID1 = @e[type=arrow,limit=1,sort=nearest] abch.tpaUUID1 if score @s abch.tpaUUID2 = @e[type=arrow,limit=1,sort=nearest] abch.tpaUUID2 if score @s abch.tpaUUID3 = @e[type=arrow,limit=1,sort=nearest] abch.tpaUUID3 if score @s abch.tpaUUID4 = @e[type=arrow,limit=1,sort=nearest] abch.tpaUUID4 run particle reverse_portal ~ ~.5 ~ 0 0.25 0 .5 20 normal
