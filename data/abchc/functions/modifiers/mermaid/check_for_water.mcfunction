...
execute unless entity @s[tag=abch.mermaid.in_water] unless score mermaid.rain abch.config matches 0 if predicate abchc:raining run function abchc:modifiers/mermaid/rain/start