# No gravity
execute as @e[ type=!player ] at @s run data modify entity @s NoGravity set value 1b
effect give @e[ type=player ] slow_falling 1 255 true
effect give @e[ type=player ] levitation 1 255 true
