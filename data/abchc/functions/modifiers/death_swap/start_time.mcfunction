...
scoreboard players operation $min random = $min abch.death_swap
scoreboard players operation $max random = $max abch.death_swap

# Get random number between min and max
function random:uniform
# Set random number to $random
#tellraw @a {"score":{"objective": "abch.rng.math","name": "out"}}
scoreboard players operation $random abch.death_swap = $out random
