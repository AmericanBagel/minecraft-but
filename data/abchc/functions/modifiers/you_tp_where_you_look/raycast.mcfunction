...
#execute if block ^ ^ ^1 minecraft:air positioned ^ ^ ^1 unless score @s abch.esLimit matches 19.. run function abchc:modifiers/explosive_sight/raycast/raytrace
...
#execute if block ^ ^ ^1 minecraft:air if score @s abch.esLimit matches 0..19 positioned ^ ^ ^1 run function abchc:modifiers/explosive_sight/raycast/raytrace
