summon creeper ~6 ~ ~-8 {Tags:["abch_crRf"]}
summon creeper ~8 ~ ~-6 {Tags:["abch_crRf"]}
summon creeper ~9 ~ ~-4 {Tags:["abch_crRf"]}
summon creeper ~10 ~ ~-2 {Tags:["abch_crRf"]}
...
execute as @e[type=creeper,tag=abch_crRf,distance=..12] at @s run spreadplayers ~ ~ 1 1 false @s
execute as @e[type=creeper,tag=abch_crRf,distance=..12] at @s run particle minecraft:large_smoke ~ ~ ~ .5 1 .5 .1 100 force