#> abchc:modifiers/creeper_mobs/run_config
...
execute if score creeper_mobs.type abch.config matches 1 as @e[type=#aestd1:hostile,tag=!global.ignore,tag=!abch.creeper_mobs.ignore,type=!creeper] at @s if entity @a[distance=..2.5,gamemode=!creative,gamemode=!spectator] unless score @s abch.creeper_mobs.fuse matches 15.. run function abchc:modifiers/creeper_mobs/fuse
execute if score creeper_mobs.type abch.config matches 2 as @e[type=#abchc:hostile_and_neutral,tag=!global.ignore,tag=!abch.creeper_mobs.ignore,type=!creeper] at @s if entity @a[distance=..2.5,gamemode=!creative,gamemode=!spectator] unless score @s abch.creeper_mobs.fuse matches 15.. run function abchc:modifiers/creeper_mobs/fuse
execute if score creeper_mobs.type abch.config matches 3 as @e[type=#abchc:mobs,tag=!global.ignore,tag=!abch.creeper_mobs.ignore,type=!creeper] at @s if entity @a[distance=..2.5,gamemode=!creative,gamemode=!spectator] unless score @s abch.creeper_mobs.fuse matches 15.. run function abchc:modifiers/creeper_mobs/fuse
