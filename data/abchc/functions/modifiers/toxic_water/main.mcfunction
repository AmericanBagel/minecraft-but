...
execute as @a[ tag=!abch.blacklist, tag=!abch.toxic_water.blacklist, gamemode=!creative, gamemode=!spectator, tag=abch.toxic_water.rain] at @s run function abchc:modifiers/toxic_water/in_rain
