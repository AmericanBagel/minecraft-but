...
execute if score #hit abch.explosive_sight.raycast matches 0 if score #distance abch.explosive_sight.raycast matches ..140 positioned ^ ^ ^0.5 run function abchc:modifiers/explosive_sight/raycast/ray