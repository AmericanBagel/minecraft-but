...
execute as @a[tag=!abch.blacklist,tag=!abch.limited_inventory.blacklist,tag=!global.ignore,tag=!abch.limited_inventory.blacklist,gamemode=!creative] at @s run function abchc:modifiers/limited_inventory/actions
