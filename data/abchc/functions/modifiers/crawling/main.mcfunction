...
execute as @a[tag=!abch.crawling.blacklist, tag=!abch.blacklist, nbt=!{abilities:{flying:1b}}, nbt=!{OnGround:0b}, tag=!abch.crawling.creative ] at @s run function abchc:modifiers/crawling/barriers
