...
execute as @a store result score @s abch.lagUUID1 run data get entity @s UUID[0]
execute as @a store result score @s abch.lagUUID2 run data get entity @s UUID[1]
execute as @a store result score @s abch.lagUUID3 run data get entity @s UUID[2]
execute as @a store result score @s abch.lagUUID4 run data get entity @s UUID[3]
#endregion
...
execute as @a at @s if score @s abch.lagTimer matches 60.. run function abchc:modifiers/lag/marker
