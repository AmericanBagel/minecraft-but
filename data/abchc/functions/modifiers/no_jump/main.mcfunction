...
execute as @a[ tag=!abch.blacklist, scores={ abch.jump=1.. } ] at @s run tellraw @a[ tag=!abch.blacklist, tag=!global.ignore ] [{"selector":"@s"},{"text":" experienced patellar fracture from jumping."}]
