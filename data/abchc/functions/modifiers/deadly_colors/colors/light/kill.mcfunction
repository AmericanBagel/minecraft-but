...
execute if score gamerule.showDeathMessages abch.config matches 1 run tellraw @a[ tag=!abch.blacklist, tag=!global.ignore ] ["",{"selector":"@s","color":"#dddddd"},{"text":" was oversaturated with ","color":"#dddddd"},{"text":"bright colors","color":"#ffffff"}]
kill @s
