...
execute if score showDeathMessages abch.config matches 1 run tellraw @a ["",{"selector":"@s","color":"#dddddd"},{"text":" was oversaturated with ","color":"#dddddd"},{"text":"bright colors","color":"#ffffff"}]
kill @s
