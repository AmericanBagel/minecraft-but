#> abchc:modifiers/death_orb/visuals/3
...
execute at @s facing entity @p[ tag=abch.death_orb.this] eyes run particle portal ^ ^ ^1 0 0 0 1 35 force

execute at @s facing entity @p[ tag=abch.death_orb.this] eyes run particle reverse_portal ^ ^ ^ 0 0 0 .35 35 force