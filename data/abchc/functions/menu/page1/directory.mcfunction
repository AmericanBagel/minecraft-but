...
execute if score @s abch.menu.selection matches 7 run scoreboard players set @s abch.menu.page 2
execute if score @s abch.menu.selection matches 8 run scoreboard players set @s abch.menu.page 2
execute if score @s abch.menu.selection matches 9 run scoreboard players set @s abch.menu.page 2
...
execute if score @s abch.menu.selection matches 25 run scoreboard players set @s abch.menu.page 2
execute if score @s abch.menu.selection matches 26 run scoreboard players set @s abch.menu.page 2