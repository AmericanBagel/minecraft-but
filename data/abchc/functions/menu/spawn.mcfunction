...
summon chest_minecart ^ ^ ^2 {Tags: [ "abch", "abch.menu", "invisible_minecart", "global.ignore", "init" ], CustomName: '{"text":"Menu"}', CustomDisplayTile: 1, DisplayState: {Name: "minecraft:air"}}
