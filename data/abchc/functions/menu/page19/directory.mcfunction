...
execute if score @s abch.menu.selection matches 11 run scoreboard players set @s abch.menu.page 20

execute if score @s abch.menu.selection matches 12 run function abchc:menu/page0/blank
# First expansion pack 1 page
execute if score @s abch.menu.selection matches 13 run scoreboard players set @s abch.menu.page 30

# First expansion pack 2 page
execute if score @s abch.menu.selection matches 14 run scoreboard players set @s abch.menu.page 40

# First expansion pack 3 page
execute if score @s abch.menu.selection matches 15 run scoreboard players set @s abch.menu.page 50

# First expansion pack 4 page
execute if score @s abch.menu.selection matches 16 run scoreboard players set @s abch.menu.page 60

# First expansion pack 5 page
execute if score @s abch.menu.selection matches 17 run scoreboard players set @s abch.menu.page 70
