...
execute unless score global abch.debug matches 1 if score @s abch.msel matches 11 run scoreboard players set @s abch.debug 1
execute if score global abch.debug matches 1 if score @s abch.msel matches 11 run scoreboard players set @s abch.debug 0
...
execute if score @s abch.msel matches 17 run scoreboard players set @s abch.mpage 12
