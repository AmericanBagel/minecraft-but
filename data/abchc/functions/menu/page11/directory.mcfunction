...
execute unless score .global abch.debug matches 1 if score @p[tag=abch.menu.this] abch.menu.selection matches 11 run scoreboard players set @p[tag=abch.menu.this] abch.debug 1
execute if score .global abch.debug matches 1 if score @p[tag=abch.menu.this] abch.menu.selection matches 11 run scoreboard players set @p[tag=abch.menu.this] abch.debug 0
...
execute if score @p[tag=abch.menu.this] abch.menu.selection matches 17 run scoreboard players set @p[tag=abch.menu.this] abch.menu.page 12
...
execute if score @p[tag=abch.menu.this] abch.debug matches 0..1 run function abchc:menu/page11/toggle