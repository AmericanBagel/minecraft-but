...
execute if score @p[tag=abch.menu.this] abch.menu.selection matches 13 run scoreboard players set @p[tag=abch.menu.this] abch.menu.page 11
execute if score @p[tag=abch.menu.this] abch.menu.selection matches 14 run function abchc:menu/page0/blank
execute if score @p[tag=abch.menu.this] abch.menu.selection matches 15 run function abchc:uninstall
...
execute if score @p[tag=abch.menu.this] abch.debug matches 0..1 run function abchc:menu/page12/toggle