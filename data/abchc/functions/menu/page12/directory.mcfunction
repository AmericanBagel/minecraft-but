...
execute if score selection abch.menu matches 13 run scoreboard players set @s abch.menu 11
execute if score selection abch.menu matches 14 run function abchc:menu/page0/blank
execute if score selection abch.menu matches 15 run function abchc:uninstall
