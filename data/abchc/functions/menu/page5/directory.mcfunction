...
##execute if score selection  matches 1 run scoreboard players set @s  1
...
execute if score @s abch.menu.selection matches 10 run scoreboard players set @s abch.menu.page 19
