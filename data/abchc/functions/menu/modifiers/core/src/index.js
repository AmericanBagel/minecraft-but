...
categories.forEach(category => {
        ...
        let categoryFunction = outdent`
            ...
            #> Modifiers\n
        `;
        const modsInCategory = modifiers.filter(modifier => modifier.info.category === category.id);
        ...
        for (let i = 0; i < modsInCategory.length; i++) {
            ...
            modifierDescription = parseDescription(modifier.info.description);

            if (Object.values(modifier.config).length > 0 | modifier.info.difficulty === true) {
                categoryFunction += outdent`
                    ## ${modifier.info.name} (${modifier.info.id})
                    # ${modifier.info.description}
                    execute unless score ${modifier.info.id} abch.toggle matches 1 run tellraw @s [{"text":" [✖] ","bold":false,"color":"#FF0000","clickEvent":{"action":"run_command","value":"/function abchc:menu/modifiers/core/${modifier.info.id}/on"}},{"text":"[","color":"#CACACA","clickEvent":{"action":"run_command","value":"/function abchc:menu/modifiers/core/${modifier.info.id}/config"}},{"text":"⚙","bold":true,"color":"#CACACA","clickEvent":{"action":"run_command","value":"/function abchc:menu/modifiers/core/${modifier.info.id}/config"}},{"text":"] ","color":"#CACACA","bold":false,"clickEvent":{"action":"run_command","value":"/function abchc:menu/modifiers/core/${modifier.info.id}/config"}},{"text":"${modifier.info.name}","bold":false,"color":"${categoryGradient[i]}"}","hoverEvent": {"action":"show_text","contents":[${modifierDescription}]}}]
                    execute if score ${modifier.info.name} abch.toggle matches 1 run tellraw @s [{"text":" [✔] ","bold":false,"color":"#3ED011","clickEvent":{"action":"run_command","value":"/function abchc:menu/modifiers/core/${modifier.info.name}/off"}},{"text":"[","color":"#CACACA","clickEvent":{"action":"run_command","value":"/function abchc:menu/modifiers/core/${modifier.info.name}/config"}},{"text":"⚙","bold":true,"color":"#CACACA","clickEvent":{"action":"run_command","value":"/function abchc:menu/modifiers/core/${modifier.info.name}/config"}},{"text":"] ","color":"#CACACA","bold":false,"clickEvent":{"action":"run_command","value":"/function abchc:menu/modifiers/core/${modifier.info.name}/config"}},{"text":"${modifier.info.name}","bold":false,"color":"${categoryGradient[i]}","hoverEvent": {"action":"show_text","contents":[${modifierDescription}]}}]
                `;
            } else {
                categoryFunction += outdent`
                    ## ${modifier.info.name} (${modifier.info.id})
                    # ${modifier.info.description}
                    execute unless score ${modifier.info.id} abch.toggle matches 1 run tellraw @s [{"text":" [✖] ","bold":false,"color":"#FF0000","clickEvent":{"action":"run_command","value":"/function abchc:menu/modifiers/core/${modifier.info.id}/on"}},{"text":"${modifier.info.name}","bold":false,"color":"${categoryGradient[i]}"}","hoverEvent": {"action":"show_text","contents":[${modifierDescription}]}}]
                    execute if score ${modifier.info.name} abch.toggle matches 1 run tellraw @s [{"text":" [✔] ","bold":false,"color":"#3ED011","clickEvent":{"action":"run_command","value":"/function abchc:menu/modifiers/core/${modifier.info.name}/off"}},{"text":"${modifier.info.name}","bold":false,"color":"${categoryGradient[i]}","hoverEvent": {"action":"show_text","contents":[${modifierDescription}]}}]
                `;
            }
        }

        fs.writeFileSync(path.join(__dirname, '../', category.id), categoryFunction);
    })
