...
# If you get too close, mobs will explode like creepers!
...
# Say goodbye to your precious world and your precious builds. These guys went from gunpowder to nuclear fuel. There's no stopping these guys. 
...
# Fun for the whole family! Great with 'Arrows are fast'!
...
## Eggs explode (explosive_arrows)
# Scrambled? Devilled? Boiled? Explosive?
execute unless score explosive_arrows abch.toggle matches 1 run tellraw @s [{"text":" [✖] ","bold":false,"color":"#FF0000","clickEvent":{"action":"run_command","value":"/function abchc:menu/modifiers/core/explosive_arrows/on"}},{"text":"[","color":"#CACACA","clickEvent":{"action":"run_command","value":"/function abchc:menu/modifiers/core/explosive_arrows/config"}},{"text":"⚙","bold":true,"color":"#CACACA","clickEvent":{"action":"run_command","value":"/function abchc:menu/modifiers/core/explosive_arrows/config"}},{"text":"] ","color":"#CACACA","bold":false,"clickEvent":{"action":"run_command","value":"/function abchc:menu/modifiers/core/explosive_arrows/config"}},{"text":"Eggs explode","bold":false,"color":"#cd500e","hoverEvent": {"action":"show_text","contents":[{"text":"Scrambled? Devilled? Boiled? Explosive?","color":"#ECEFF5"}]}}]



execute if score explosive_arrows abch.toggle matches 1 run tellraw @s [{"text":" [✔] ","bold":false,"color":"#3ED011","clickEvent":{"action":"run_command","value":"/function abchc:menu/modifiers/core/explosive_arrows/off"}},{"text":"[","color":"#CACACA","clickEvent":{"action":"run_command","value":"/function abchc:menu/modifiers/core/explosive_arrows/config"}},{"text":"⚙","bold":true,"color":"#CACACA","clickEvent":{"action":"run_command","value":"/function abchc:menu/modifiers/core/explosive_arrows/config"}},{"text":"] ","color":"#CACACA","bold":false,"clickEvent":{"action":"run_command","value":"/function abchc:menu/modifiers/core/explosive_arrows/config"}},{"text":"Eggs explode","bold":false,"color":"#cd500e","hoverEvent": {"action":"show_text","contents":[{"text":"Scrambled? Devilled? Boiled? Explosive?","color":"#ECEFF5"}]}}]

## Everywhere you look explodes (explosive_sight)
# Everywhere players look explodes!
...
# All bats carry TNT which detonates near players.
...
# TNT rains from the sky! The end is nigh!
