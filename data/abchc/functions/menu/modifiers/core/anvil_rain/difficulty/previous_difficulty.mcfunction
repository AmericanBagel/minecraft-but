#> abchc:menu/anvil_rain/difficulty/previous_difficulty
...
execute unless score difficulty.anvil_rain abch.config matches 0..3 run scoreboard players operation difficulty.anvil_rain abch.config = difficulty.global abch.config

#> Set difficulty to temp score
scoreboard players operation #temp abch.config = difficulty.anvil_rain abch.config
...
scoreboard players operation difficulty.anvil_rain abch.config = #temp abch.config
