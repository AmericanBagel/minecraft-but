#> abchc:menu/tnt_bats/difficulty/previous_difficulty
...
execute unless score difficulty.tnt_bats abch.config matches 0..3 run scoreboard players operation difficulty.tnt_bats abch.config = difficulty.global abch.config

#> Set difficulty to temp score
scoreboard players operation #temp abch.config = difficulty.tnt_bats abch.config
...
scoreboard players operation difficulty.tnt_bats abch.config = #temp abch.config
