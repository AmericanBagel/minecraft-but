...
# Miscellaneous
tellraw @s [{"text":" |→ ","color":"#ECEFF5","hoverEvent":{"action":"show_text","contents":[{"text":"Click here to go to the ","color":"#ECEFF5"},{"text":"Miscellaneous","color":"#A8A8A8"},{"text":" page which lists challenge modifiers.","color":"#ECEFF5"}]},"clickEvent":{"action":"run_command","value":"/function abchc:menu/modifiers/core/misc"}},{"text":"Miscellaneous","color":"#A8A8A8","hoverEvent":{"action":"show_text","contents":[{"text":"Click here to go to the ","color":"#ECEFF5"},{"text":"Miscellaneous","color":"#A8A8A8"},{"text":" page which lists mob modifiers.","color":"#ECEFF5"}]},"clickEvent":{"action":"run_command","value":"/function abchc:menu/modifiers/core/misc"}}]
