...
# 2 - Anvil Rain
data modify entity @e[type=chest_minecart,tag=abch.menu,limit=1,sort=nearest] Items insert 0 value {Slot:1b,id:"minecraft:anvil",Count:1b,tag:{display:{Name:'{"text":"Anvil Rain","color":"#735ED1","bold":"true","italic":"false"}',Lore:['{"text":"Anvils rain from the sky.","color":"#d1d1d1","italic":"false"}']},HideFlags:32,abch:{isMenu:1b,page:20,selection:2}}}

# 3 - Anemia-induced Nausea
data modify entity @e[type=chest_minecart,tag=abch.menu,limit=1,sort=nearest] Items insert 0 value {Slot:2b,id:"minecraft:poisonous_potato",Count:1b,tag:{display:{Name:'{"text":"Anemia-induced Nausea","color":"#98D15E","bold":"true","italic":"false"}',Lore:['{"text":"Taking damage causes nausea.","color":"#d1d1d1","italic":"false"}']},HideFlags:32,abch:{isMenu:1b,page:20,selection:3}}}
...
# 5 - Blindness
data modify entity @e[type=chest_minecart,tag=abch.menu,limit=1,sort=nearest] Items insert 0 value {Slot:4b,id:"minecraft:ender_pearl",Count:1b,tag:{display:{Name:'{"text":"Blindness","color":"#5e0e27","italic":"false","bold":"true"}',Lore:['{"text":"Players are blinded.","italic":"false","color":"#d1d1d1"}']},HideFlags:32,abch:{isMenu:1b,page:20,selection:5}}}
...
# 7 - Creeper Nukes
data modify entity @e[type=chest_minecart,tag=abch.menu,limit=1,sort=nearest] Items insert 0 value {Slot:6b,id:"minecraft:creeper_spawn_egg",Count:1b,tag:{display:{Name:'{"text":"Creeper Nukes","color":"#09bc18","bold":"true","italic":"false"}',Lore:['{"text":"Give me a hug!","color":"#d1d1d1","italic":"false"}']},HideFlags:32,abch:{isMenu:1b,page:20,selection:7}}}
...
# 9 - Deadly Falls
data modify entity @e[type=chest_minecart,tag=abch.menu,limit=1,sort=nearest] Items insert 0 value {Slot:8b,id:"minecraft:elytra",Count:1b,tag:{display:{Name:'{"text":"Deadly Falls","color":"#0ab59b","bold":"true","italic":"false"}',Lore:['{"text":"Any fall damage","color":"#d1d1d1","italic":"false"}','{"text":"becomes lethal.","color":"#d1d1d1","italic":"false"}']},HideFlags:32,abch:{isMenu:1b,page:20,selection:9}}}
...
## Column 3
# Bottom Menu
data modify entity @e[type=chest_minecart,tag=abch.menu,limit=1,sort=nearest] Items insert 0 value {Slot:18b,id:"minecraft:gray_stained_glass_pane",Count:1b,tag:{display:{Name:'{"text":" "}'},HideFlags:32,abch:{isMenu:1b,page:20,selection:19}}}
data modify entity @e[type=chest_minecart,tag=abch.menu,limit=1,sort=nearest] Items insert 0 value {Slot:19b,id:"minecraft:gray_stained_glass_pane",Count:1b,tag:{display:{Name:'{"text":" "}'},HideFlags:32,abch:{isMenu:1b,page:20,selection:20}}}
data modify entity @e[type=chest_minecart,tag=abch.menu,limit=1,sort=nearest] Items insert 0 value {Slot:20b,id:"minecraft:gray_stained_glass_pane",Count:1b,tag:{display:{Name:'{"text":" "}'},HideFlags:32,abch:{isMenu:1b,page:20,selection:21}}}
data modify entity @e[type=chest_minecart,tag=abch.menu,limit=1,sort=nearest] Items insert 0 value {Slot:21b,id:"minecraft:gray_stained_glass_pane",Count:1b,tag:{display:{Name:'{"text":" "}'},HideFlags:32,abch:{isMenu:1b,page:20,selection:22}}}
data modify entity @e[type=chest_minecart,tag=abch.menu,limit=1,sort=nearest] Items insert 0 value {Slot:22b,id:"minecraft:barrier",Count:1b,tag:{display:{Name:'{"text":"Back","color":"red","bold":"true","italic":"false"}'},HideFlags:32,abch:{isMenu:1b,page:1,selection:23}}}
data modify entity @e[type=chest_minecart,tag=abch.menu,limit=1,sort=nearest] Items insert 0 value {Slot:23b,id:"minecraft:gray_stained_glass_pane",Count:1b,tag:{display:{Name:'{"text":" "}'},HideFlags:32,abch:{isMenu:1b,page:20,selection:24}}}
data modify entity @e[type=chest_minecart,tag=abch.menu,limit=1,sort=nearest] Items insert 0 value {Slot:24b,id:"minecraft:gray_stained_glass_pane",Count:1b,tag:{display:{Name:'{"text":" "}'},HideFlags:32,abch:{isMenu:1b,page:20,selection:25}}}
data modify entity @e[type=chest_minecart,tag=abch.menu,limit=1,sort=nearest] Items insert 0 value {Slot:25b,id:"minecraft:gray_stained_glass_pane",Count:1b,tag:{display:{Name:'{"text":" "}'},HideFlags:32,abch:{isMenu:1b,page:20,selection:26}}}
